...
/* XXX: there's too many rb_intern() and rb_class2path/rb_path2class stuff */
/* XXX: should we perhaps taint strings we convert here... */
...
GdaValue *rb_rb_value_to_gda_value_try_as_string(value, type, message)
    VALUE value;
    GdaValueType type;
    const char *message;
{
